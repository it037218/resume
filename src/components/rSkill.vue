<template>
  <div class="-skill">
    <div class="-title" v-text="skillMsg.title"></div>
    <div class="-content">
      <div class="-contain">
        <div class="-skill-circle">
          <ul class="-outCircle">
            <li class="-out" :style="{'background-color':item.color}" v-for="item in skillMsg.outCircleList"
                v-text="item.name">
            </li>
          </ul>
          <ul class="-innerCircle">
            <li class="-inner" :style="{'background-color':item.color}" v-for="item in skillMsg.innerCircleList"
                v-text="item.name">
            </li>
          </ul>
        </div>
        <div class="-des">
          <p v-for="item in skillMsg.desList" v-text="item"></p>
        </div>
      </div>
